...
> 最后更新:2026-06-14(**win-laptop** 第四场:Win 安装包重打 + 卡 splash 双根因修复(VC++ CRT app-local / seed shell 转义)+ MSI MAX_PATH(删 .pnpm)+ WebView2 离线 + 全盘验收三项 PASS · 详见 [PROGRESS](PROGRESS.md))
> 上一版:2026-06-14(win-laptop 第三场:全盘深度审计(依赖CVE 4→0 / 代码漏洞×3遍 / 模块逻辑 / 传导链路)+ 21 漏洞全修复)
