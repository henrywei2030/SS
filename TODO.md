...
> 最后更新:2026-06-14(**win-laptop** 第五场:卡 splash【终极根因 strip_unc · `\\?\` 路径】+ 转 **NSIS 单用户安装**(避只读)+ splash 进度条 + 7 项 app 修复(WebView2 吞 confirm 系统性 sweep / 性能 / 顶栏重排)· 详见 [PROGRESS](PROGRESS.md))
> 上一版:2026-06-14(win-laptop 第四场:Win 安装包重打 + 卡 splash 双根因修复(VC++ CRT / seed shell)+ MSI MAX_PATH + WebView2 离线)
