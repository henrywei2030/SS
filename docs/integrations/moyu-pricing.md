...
claude-sonnet-4-6 Anthropic claude-sonnet-4-6是由 Anthropic 推出的高性能平衡型大模型版本，兼具强推理能力与稳定长上下文处理能力，适用于企业级复杂文本与 Agent 工作流场景。 - 按量计费 anthropic openai 输入 ¥7.4860 / 1M tokens 输出 ¥37.4300 / 1M tokens Lite-Claude分组
